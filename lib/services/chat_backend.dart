...
class ChatDone extends ChatEvent {
  ...
  /// `finish_reason` — so an answer clipped at the server's `max_tokens` is
  /// indistinguishable from a complete one and [truncatedByLength] stays
  /// false. That is a server-side gap, not something the client can infer.
